...
class ResourceOptions:
    ...
    process to identify potential validation errors. Default value is
    ``False``.
    """

    def __init__(self, **kwargs):
        self._meta = ResourceOptions()
    ...
    @property
    def exclude(self):
        return self._meta.exclude

    @exclude.setter
    def exclude(self, exclude):
        self._meta.exclude = exclude

    @property
    def import_id_fields(self):
        return self._meta.import_id_fields

    @import_id_fields.setter
    def import_id_fields(self, import_id_fields):
        self._meta.import_id_fields = import_id_fields

    @property
    def import_order(self):
        return self._meta.import_order

    @import_order.setter
    def import_order(self, import_order):
        self._meta.import_order = import_order
    ...
    @export_order.setter
    def export_order(self, export_order):
        self._meta.export_order = export_order

    @property
    def widgets(self):
        return self._meta.widgets

    @widgets.setter
    def widgets(self, widgets):
        self._meta.widgets = widgets

    @property
    def use_transactions(self):
        return self._meta.use_transactions

    @use_transactions.setter
    def use_transactions(self, use_transactions):
        self._meta.use_transactions = use_transactions

    @property
    def skip_unchanged(self):
        return self._meta.skip_unchanged

    @skip_unchanged.setter
    def skip_unchanged(self, skip_unchanged):
        self._meta.skip_unchanged = skip_unchanged
    ...
    @skip_diff.setter
    def skip_diff(self, skip_diff):
        self._meta.skip_unchanged = skip_diff

    @property
    def clean_model_instances(self):
        return self._meta.clean_model_instances

    @clean_model_instances.setter
    def clean_model_instances(self, clean_model_instances):
        self._meta.clean_model_instances = clean_model_instances

    @property
    def report_skipped(self):
        return self._meta.report_skipped

    @report_skipped.setter
    def report_skipped(self, report_skipped):
        self._meta.report_skipped = report_skipped
